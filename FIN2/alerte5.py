...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # Initialiser le numéro de ligne à 1selecte
        self.numero_ligne = 1
        ...
        self.ajouter_element_arborescence("192.168.1.1", "192.168.1.2","DHCPACK","10.10.10.10","macdst","Informations 1","time")
        self.ajouter_element_arborescence("192.168.1.1", "192.168.1.2","DHCPDECLINE","11.10.10.10","macdst","Informations 1","time")
    ...
    # Récupérer la valeur de l'Entry
        ...
        for item in self.packet_tree.get_children():
            ...
            if packet_type in ['DHCPOFFER', 'DHCPDECLINE', 'DHCPACK', 'DHCPNAK']:
