...
import psutil
from snif2 import *
from snif2 import lancement_sniffing
from snif2 import traitement_paquet
import time
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.search_entry = customtkinter.CTkEntry(self, textvariable=self.search_entry_var,width=1100,font=("Helvetica", 20))
        ...
        self.alerte_label1 = customtkinter.CTkLabel(self, text="Adresse du DHCP", font=customtkinter.CTkFont(size=15))
        ...
        #self.ajouter_element_arborescence("192.168.1.1", "192.168.1.2","Request","macsrc","macdst","Informations 1","time")
    ...
    def sidebar_button_event_start(self):
        ...
        self.sniffer = lancement_sniffing("Wi-FI")
        self.sniffer.start()
    ...
    def ajouter_element_periodiquement(self):
        ...
        self.ajouter_element_arborescence("192.168.1.1", "192.168.1.2","Request","macsrc","macdst","Informations 1",timetest)
