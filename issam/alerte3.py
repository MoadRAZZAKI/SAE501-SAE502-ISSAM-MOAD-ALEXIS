...
import csv
import psutil
from sniffer2 import lancement_sniffing
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.search_entry = customtkinter.CTkEntry(self, textvariable=self.search_entry_var,width=1000,font=("Helvetica", 20))
        ...
        # Bouton nouvelle page    Nous utilis
