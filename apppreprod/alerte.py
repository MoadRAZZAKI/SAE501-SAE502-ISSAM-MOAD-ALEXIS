...
class App(customtkinter.CTk):
    ...
    def item_double_clicked(self, event):
        ...
        new_window.title("Paquet" + values[0])

        new_window.grid_columnconfigure(1, weight=1)
        new_window.grid_columnconfigure((0, 1, 2), weight=2)
        new_window.grid_rowconfigure((0, 1, 2), weight=1)

        # Créer un canevas avec un rectangle coloré
        ...
        tabview_1 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_1.pack(pady=5, padx=5)
        tabview_1.add("Numéro")
        

        tabview_2 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_2.pack(pady=5, padx=5)
        tabview_2.add("Heure")
        
        tabview_3 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_3.pack(pady=5, padx=5)
        tabview_3.add("Ip source")

    
        tabview_4 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_4.pack(pady=5, padx=5)
        tabview_4.add("Ip Destination")

        tabview_5 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_5.pack(pady=5, padx=5)
        tabview_5.add("Type")

        tabview_6 = customtkinter.CTkTabview(master=frame_1, width=300, height=130)
        tabview_6.pack(pady=5, padx=5)
        tabview_6.add("Informations")
